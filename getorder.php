...
if ($_SERVER["REQUEST_METHOD"] === 'GET')
{
    ...
    if($status==1||$status==2){
        ...
        $query = "INSERT INTO orders(`id`,`order_id`,`user`,`to_phone`,`to_email`,`minutes`,`preference`,`message`,`status`)   
        VALUES('".$id."','".$order_id."','".$user."','".$to_phone."','".$to_email."','".$minutes."','".$preference."','".$message."','".$status."')";
